...
latex_documents = [
    (master_doc, 'pensive.tex', 'pensive Documentation',
     'Ryan G. James', 'manual'),
]
...
man_pages = [
    (master_doc, 'pensive', 'pensive Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pensive', 'pensive Documentation',
     author, 'pensive', 'One line description of project.',
     'Miscellaneous'),
]
